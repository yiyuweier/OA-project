...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="./jsp/SysManage/images/title_arrow.gif"/> 发起请假流程
        </div>
...
<!--显示表单内容-->
<div id="MainArea">
    <form action="startProcessInstance_askForLeave" method="post" id="myform">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                 	<tr>
                        <td>
                        	<s:textfield id="reason" name="reason" label="请假原因"/>
                        </td>
                    </tr>
                    <tr>
                    	<td>
                        	<s:radio list='#{"1":"婚假", "2":"产假", "3":"病假","4":"倒休"}' id="selecttype" name="selecttype" label="请假类型"/>
                        </td>
                    </tr>
                    <tr>
                    	<td>
                        	<s:textfield id="begintime" name="begintime" label="请假起始时间" onClick="WdatePicker()"/>
                        </td>
                    </tr>
                    <tr>
                    	<td>
                    		<s:select list="{1,2,3,4,5,6,7}" id="time" name="time" label="天数"/>
                    	</td>
                    </tr>
                    <tr>
                    	<td>
        ...
        <div id="InputDetailBar">
            <input type="button" src="./jsp/SysManage/images/save.png" onclick="save()" value="提交"/>
            <input type="button" src="./jsp/SysManage/images/save.png" onclick="javascript:history.go(-1);" value="返回"/>
        </div>
    </form>
</div>
				...
				<div class="content">
  						...
  						<table id="userPickerGrid" class="m-table table-hover">
    						...
    						<s:iterator value="users">
    							<tr>
    								<td>
    									<input id="selectedItem${id}" type="radio" class="selectedItem" name="selectedItem" value="${id}:${U_name}">
    								</td>
    								<td>${U_name}</td>
    							</tr>
    						</s:iterator>
...
<script type="text/javascript" charset="utf-8">
   ...
   function save(){
   		...
   		if(!uniform_selecttype1.checked&&!uniform_selecttype2.checked&&!uniform_selecttype3.checked&&!uniform_selecttype4.checked){
