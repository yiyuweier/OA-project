...
<form id="myform" name="myform" action="startProcessInstance_DocumentForeditor" method="post" onsubmit="return false;">
	...
	<div class="summary" id="summaryDiv">
 		<div class="divline">
  			...
  			<div class="col-input" id="col_subject">
   				<input name="D_name" id="D_name" type="text" class="input-text" maxlength="200" defaultValue="<点击此处填写标题>" value="${Document_name}" onfocus='checkDefSubject(this, true)' onblur="checkDefSubject(this, false)">
  			</div>
 		...
 		<div class="divline">
 			<div class="col-label width-65px">发送到：</div>
  			...
  			<div class="col-input">
  				<s:radio list="#{'1':'串行','2':'并行'}" name="D_type" id="D_type" label="会签方式" value="%{#session.Document_type}"/>
  			</div>
 		</div>
	</div>
   	<textarea name="D_content" id="D_content">${Document_content}</textarea>
</form>
