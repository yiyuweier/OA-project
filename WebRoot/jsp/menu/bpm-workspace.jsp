      ...
      <aside id="m-sidebar" class="accordion span2" data-spy="affix" data-offset-top="100">
        		<div class="accordion-group">
		          <div class="accordion-heading">
		            <a class="accordion-toggle" data-toggle="collapse" data-parent="#m-sidebar" href="#${P_name}">
		              <i class="icon-user"></i>
		              <span class="title" onclick="doLeftMenuClick('Dashboard.action','123')">首页</span>
		            </a>
		          </div>
		         </div>
			...
			<s:if test="#session.user.hasPrivilegeByName(P_name)">
		        <div class="accordion-group">
		          <div class="accordion-heading">
		            <a class="accordion-toggle" data-toggle="collapse" data-parent="#m-sidebar" href="#${P_name}">
		              <i class="icon-user"></i>
		              <span class="title">${P_name}</span>
		            </a>
		          </div>
		          <div id="${P_name}" class="accordion-body collapse">
		            <ul class="accordion-inner nav nav-list">
		            	<s:iterator value="children">
							<s:if test="#session.user.hasPrivilegeByName(P_name)">
					  			<li><a onclick="doLeftMenuClick('${P_url}','123')"><i class="icon-user"></i>${P_name}</a></li>
					  		</s:if>
						</s:iterator>
		            </ul>
		          </div>
