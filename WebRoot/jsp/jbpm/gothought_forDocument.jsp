...
var zTreeRoleObj,
  ...
  <body>
  	<s:form action="Jbpm_issued" method="post">
		...
		<p>
			发送到：<input id="trackInput" name="D_sendto" type="text" class="input-text" style="cursor:pointer;" readonly maxlength="200" title="<点击此处添加发送对象>" value="<点击此处添加发送对象>" onclick="$('#userPicker').window('open');return false;">(默认是发送到所有人，如果要指定发送到某些人，请选择要发送的对象)
		</p>
		<p>
			<input type="submit" name="ISPASS" value="打印">
			<input type="submit" name="ISSUED" value="下发">
		</p>
		<div id="footer">
		</div>
	</s:form>
